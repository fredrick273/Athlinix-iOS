...
struct cSocialMediaFeedView: View {
    ...
    let feedPosts: [FeedPost] = [
        ...
        FeedPost(author: Account(name: "JJ Redci", avatarImage: "person.circle.fill"), photos: ["feed"], totalLikes: 64, message: "Last Day at SRMIST Court", logo: "pistons"),
    ]
...
struct cAccountProfileView: View {
    let account: Account
...
struct cFeedPostImagesView: View {
    let photos: [String]
...
struct cInteractionSection: View {
    let feedPost: FeedPost
    @Binding var favoritePosts: Set<UUID>
...
// Preview
struct cSocialMediaFeedView_Previews: PreviewProvider {
